...
const insert = (req, insertObj) => {
  try {
    ...
    const organizationalInformation = {
      ...
      phoneNumber: insertObj?.organizationalInformation?.bussinessContactNumber,
      organizatioDescription: insertObj?.organizationalInformation?.organizatioDescription,
